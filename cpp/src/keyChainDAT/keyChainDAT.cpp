...
KeyChainDAT::KeyChainDAT(const OP_NodeInfo* info) : myNodeInfo(info)
{
	myExecuteCount = 0;
	myOffset = 0.0;
...
void
KeyChainDAT::getGeneralInfo(DAT_GeneralInfo* ginfo, const OP_Inputs* inputs, void* reserved1)
{
...
void
KeyChainDAT::makeTable(DAT_Output* output, int numRows, int numCols)
{
...
void
KeyChainDAT::makeText(DAT_Output* output)
{
