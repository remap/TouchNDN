...
NamespaceDAT::NamespaceDAT(const OP_NodeInfo* info) : myNodeInfo(info)
{
	myExecuteCount = 0;
	myOffset = 0.0;
...
void
NamespaceDAT::makeTable(DAT_Output* output, int numRows, int numCols)
{
...
void
NamespaceDAT::makeText(DAT_Output* output)
{
...
int32_t
NamespaceDAT::getNumInfoCHOPChans(void* reserved1)
{
...
void
NamespaceDAT::getInfoCHOPChan(int32_t index,
...
void
NamespaceDAT::getInfoDATEntries(int32_t index,
									int32_t nEntries,
